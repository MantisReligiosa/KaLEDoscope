...
namespace SevenSegmentBoardDevice
{
    public static class Refs
    {
        ...
        public static readonly List<FontType> FontTypes = new List<FontType>
        {
            new FontType
            {
                Id = 1,
        ...
        public static readonly List<DisplayFormat> DisplayFormats = new List<DisplayFormat>
        {
            new DisplayFormat
            {
                Id = 1,
        ...
        public static readonly List<CountdownType> CountdownTypes = new List<CountdownType>
        {
            new CountdownType
            {
                Id = 1,
        ...
        public static readonly List<DisplayFrame> DisplayFrames = new List<DisplayFrame>
        {
            new DisplayFrame
            {
                Id = 1,
        ...
        public static readonly List<SyncSource> SyncSources = new List<SyncSource>
        {
            new SyncSource
            {
                Id = 1,
