...
namespace SevenSegmentBoardDevice
{
    public class SevenSegmentDeviceBuilder : IDeviceBuilder
    {
        ...
        public IEnumerable<Func<Device, INetworkAgent, ILogger, IConfig, IDeviceCommand<Device>>> GetDownloadCommands()
            ...
            {
                (d, n, l, c) => new DownloadBoardTypeCommand(d, n, l, c),
                (d, n, l, c) => new DownloadAlarmsCommand(d, n, l, c),
                (d, n, l, c) => new DownloadFramesCommand(d, n, l, c),
                (d, n, l, c) => new DownloadTimeSyncConfigCommand(d, n, l, c)
            };
